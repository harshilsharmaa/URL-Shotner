    ...
    return (
        <div className='credit-page'>
            ...
            <div className="credits">
                ...
                <a href="https://www.flaticon.com/free-icons/subscription" title="subscription icons">Subscription icons created by Muhammad Atif - Flaticon</a>
                <a href="https://www.flaticon.com/free-icons/guest-list" title="guest list icons">Guest list icons created by Flat Icons - Flaticon</a>
                <a href="https://www.flaticon.com/free-icons/tick" title="tick icons">Tick icons created by Ian June - Flaticon</a>
